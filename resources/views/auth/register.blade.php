                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="des" type="des" class="form-control @error('des') is-invalid @enderror" name="des" required autocomplete="phone">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="date" type="date" class="form-control @error('date') is-invalid @enderror" name="date" required autocomplete="phone">
                        ...
                        <button type="submit" class="btn btn-primary" style="align-content: left">
                        {{ __('Add Appointment') }}
                        </button>
                    </div>
    </div>
